    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 to-slate-800 py-8 px-4">
      <div className="bg-slate-800/50 backdrop-blur-xl p-6 rounded-2xl shadow-2xl w-full max-w-md border border-slate-700">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 mb-2 rounded-lg border border-slate-600 bg-slate-700/50 hover:bg-slate-700 transition text-white font-medium disabled:opacity-50 disabled:cursor-not-allowed"
        >
